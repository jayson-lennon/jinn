...
pub async fn drain_routes(services: &Services) {
    ...
    forward::<jinn_domain::feat::session_lifecycle::protocol::event::SessionCwdChanged>(services)
        .await;
    forward::<jinn_domain::feat::skills::skills_scan_actor::ScanSkills>(services).await;
    ...
    reverse::<jinn_domain::feat::skills::skills_scan_actor::SkillsLoaded>(services).await;
